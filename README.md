...
本项目是基于Veins框架的车联网仿真研究，专注于校园环境下的车辆间通信(V2V)和车辆与基础设施间通信(V2I)仿真。结合OMNeT++网络仿真器和SUMO交通仿真器，实现车联网场景的建模与分析。

研究内容包括IEEE 802.11p标准下的车辆自组网通信、路侧单元(RSU)部署策略、交通灯控制优化等车联网关键技术。
