...
//my message type
#include "veins/modules/messages/ShortMessage_m.h"
#include "veins/modules/messages/LongMessage_m.h"
...
protected:
    ...
    //my message type
    /** @brief this function is called upon receiving a ShortMessage */
    virtual void onSM(ShortMessage* sm) {};

    /** @brief this function is called upon receiving a LongMessage */
    virtual void onLM(LongMessage* lm) {};
...
protected:
    ...
    /* my message type */
    uint32_t receivedSMs;
    uint32_t receivedLMs;
};
